...
import com.example.mario_game_ex1.Logic.Opponent;
import com.example.mario_game_ex1.Logic.Player;
import com.example.mario_game_ex1.Logic.Reviver;
    ...
    private void syncHeartsWithStrikes() {
        ...
        switch (strikes) {
            ...
            case 2:
                ...
                break;
            case 3:
                // TODO - Only to EX1 - we should revive the player and give hime full life
                gameMan.revive();
                main_game_IMG_hearts[0].setVisibility(View.VISIBLE);
                main_game_IMG_hearts[1].setVisibility(View.VISIBLE);
                main_game_IMG_hearts[2].setVisibility(View.VISIBLE);
